/* Main entry point */
#include "Pokemon_Pinball__U__.h"
#include "gbrt.h"
...
int Pokemon_Pinball__U___main(int argc, char* argv[]) {
    ...
    GBConfig runtime_config = *Pokemon_Pinball__U___default_config();
    ...
    if (differential_mode) {
        ...
        gb_context_set_save_id(generated_ctx, "Pokemon_Pinball__U__");
        gb_context_set_save_id(interpreted_ctx, "Pokemon_Pinball__U__");
        if (serial_stdout) {
            generated_ctx->callbacks.on_serial_byte = gbrt_serial_stdout;
        }
        Pokemon_Pinball__U___init(generated_ctx);
        Pokemon_Pinball__U___init(interpreted_ctx);
        if (data_mod_file) {
    ...
    gb_context_set_save_id(ctx, "Pokemon_Pinball__U__");
    ...
    custom_rom = gb_prompt_for_rom("Select Pokemon Pinball ROM", &custom_rom_size);
#endif
    Pokemon_Pinball__U___init(ctx);
#ifdef _WIN32
    ...
    const GBPortMetadata port_metadata = {
        ...
        .game_id = "Pokemon_Pinball__U__",
        .game_title = "Pokemon_Pinball__U__",
        .rom_sha256 = "7672001d4710272009df6a41e3cbada65decd56e0eb2f185cb3d59c08d33ea0e",
        .rom_size = 1048576u,
    };
...
int main(int argc, char* argv[]) {
    return Pokemon_Pinball__U___main(argc, argv);
}
